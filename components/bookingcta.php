                <section class="tc-contact-st1 pb-60 pt-60">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-7">
                                <h2 class="fsz-70 mb-30"> A Space <span class="cr-orange1"> Designed To Inspire </span> </h2>
                            </div>
                            <div class="col-lg-5">
                                <div class="links mb-30 text-lg-end">
